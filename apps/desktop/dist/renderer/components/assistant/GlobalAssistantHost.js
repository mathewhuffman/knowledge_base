...
export function AssistantPanelContent({ embedded = false, style, onClose, launcherPosition, onLauncherPositionChange }) {
    const { routeContext, session, sessions, messages, artifact, loading, sending, error, historyOpen, setHistoryOpen, sendMessage, resetSession, createSession, openSession, deleteSession, applyArtifact, rejectArtifact, rerunLastMessage } = useAiAssistant();
