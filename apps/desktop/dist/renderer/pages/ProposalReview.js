...
function PreviewPanel({ html, styleCss, title, }) {
    if (!html) {
        return (_jsx("div", { className: "html-preview", style: { textAlign: 'center', color: 'var(--color-text-muted)' }, children: "No content available" }));
    }
    return (_jsx("div", { className: "detail-preview-frame-card proposal-review-preview-frame-card", children: _jsx("iframe", { className: "detail-preview-frame proposal-review-preview-frame", title: title, srcDoc: buildArticlePreviewDocument(html, title, styleCss) }) }));
}
function PreviewDiffPanel({ beforeHtml, afterHtml, styleCss, title, }) {
    ...
    return (_jsx("div", { className: "detail-preview-frame-card proposal-review-preview-frame-card", children: _jsx("iframe", { className: "detail-preview-frame proposal-review-preview-frame", title: title, srcDoc: buildArticlePreviewDocument(diffHtml, title, styleCss, { extraCss: PREVIEW_DIFF_FRAME_CSS }) }) }));
}
