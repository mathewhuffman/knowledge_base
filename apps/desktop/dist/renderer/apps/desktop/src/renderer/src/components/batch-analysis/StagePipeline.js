...
function resolveNodeState(stage, currentStage, completedStages, failedStage) {
...
export function StagePipeline({ currentStage, iteration, completedStages, failedStage, isRunning, }) {
