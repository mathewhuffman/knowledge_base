...
export function DiscoveredWorkList({ items, compact }) {
    ...
    return (_jsxs("div", { className: "ba-discoveries", children: [displayItems.map((item) => {
