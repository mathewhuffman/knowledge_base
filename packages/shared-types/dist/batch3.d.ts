...
export declare enum ZendeskPublishValidationCode {
...
export declare enum PublishJobItemState {
    QUEUED = "queued",
    RUNNING = "running",
    SUCCEEDED = "succeeded",
    FAILED = "failed",
...
export type ZendeskRetireActionStatus = 'pending' | 'running' | 'failed' | 'archived' | 'already_archived';
