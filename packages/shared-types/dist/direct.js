...
exports.DIRECT_ACTION_DEFINITIONS = exports.DIRECT_ASSISTANT_TEMPLATE_ACTION_TYPES = exports.DIRECT_ASSISTANT_READ_ACTION_TYPES = exports.DIRECT_ARTICLE_EDIT_ACTION_TYPES = exports.DIRECT_BATCH_WORKER_ACTION_TYPES = exports.DIRECT_BATCH_READ_ONLY_ACTION_TYPES = exports.DIRECT_ACTION_TYPES = exports.DIRECT_MUTATION_ACTION_TYPES = exports.DIRECT_READ_ACTION_TYPES = void 0;
exports.validateDirectActionArgs = validateDirectActionArgs;
const batch6_1 = require("./batch6");
const app_working_state_1 = require("./app-working-state");
...
exports.DIRECT_ACTION_DEFINITIONS = {
    search_kb: {
        ...
        inputSchema: omitObjectSchemaProperties(batch6_1.MCP_SEARCH_KB_INPUT_SCHEMA, ['workspaceId'])
    },
    get_explorer_tree: {
    ...
    get_batch_context: {
        ...
        argsHint: '`batchId`.',
        inputSchema: omitObjectSchemaProperties(batch6_1.MCP_GET_BATCH_CONTEXT_INPUT_SCHEMA, ['workspaceId'])
    },
    get_pbi: {
        description: 'Load one PBI record from the active batch.',
        argsHint: '`pbiId`.',
        inputSchema: omitObjectSchemaProperties(batch6_1.MCP_GET_PBI_INPUT_SCHEMA, ['workspaceId'])
    },
    get_pbi_subset: {
        description: 'Load a subset of PBI rows from the active batch.',
        argsHint: '`batchId`; optional integer `rowNumbers` array.',
        inputSchema: omitObjectSchemaProperties(batch6_1.MCP_GET_PBI_SUBSET_INPUT_SCHEMA, ['workspaceId'])
    },
    get_article: {
        ...
        inputSchema: omitObjectSchemaProperties(batch6_1.MCP_GET_ARTICLE_INPUT_SCHEMA, ['workspaceId'])
    },
    get_article_family: {
        description: 'Load article-family metadata and locale context.',
        argsHint: '`familyId`.',
        inputSchema: omitObjectSchemaProperties(batch6_1.MCP_GET_ARTICLE_FAMILY_INPUT_SCHEMA, ['workspaceId'])
    },
    get_locale_variant: {
        description: 'Load one locale variant and its metadata.',
        argsHint: '`localeVariantId`.',
        inputSchema: omitObjectSchemaProperties(batch6_1.MCP_GET_LOCALE_VARIANT_INPUT_SCHEMA, ['workspaceId'])
    },
    get_article_history: {
        description: 'Load revision history for one locale variant.',
        argsHint: '`localeVariantId`.',
        inputSchema: omitObjectSchemaProperties(batch6_1.MCP_GET_ARTICLE_HISTORY_INPUT_SCHEMA, ['workspaceId'])
    },
    find_related_articles: {
        ...
        inputSchema: omitObjectSchemaProperties(batch6_1.MCP_FIND_RELATED_ARTICLES_INPUT_SCHEMA, ['workspaceId'])
    },
    list_categories: {
        description: 'List KB categories for a locale.',
        argsHint: '`locale`.',
        inputSchema: omitObjectSchemaProperties(batch6_1.MCP_LIST_CATEGORIES_INPUT_SCHEMA, ['workspaceId'])
    },
    list_sections: {
        ...
        inputSchema: omitObjectSchemaProperties(batch6_1.MCP_LIST_SECTIONS_INPUT_SCHEMA, ['workspaceId'])
    },
    list_article_templates: {
        description: 'List template packs in the workspace.',
        argsHint: 'Optional `locale` and `includeInactive`.',
        inputSchema: omitObjectSchemaProperties(batch6_1.MCP_LIST_ARTICLE_TEMPLATES_INPUT_SCHEMA, ['workspaceId'])
    },
    get_template: {
        description: 'Load one template pack payload.',
        argsHint: '`templatePackId`.',
        inputSchema: omitObjectSchemaProperties(batch6_1.MCP_GET_TEMPLATE_INPUT_SCHEMA, ['workspaceId'])
    },
    record_agent_notes: {
        ...
        inputSchema: omitObjectSchemaProperties(batch6_1.MCP_RECORD_AGENT_NOTES_INPUT_SCHEMA, ['workspaceId'])
    },
    create_proposals: {
    ...
    patch_form: {
        ...
        inputSchema: pickObjectSchemaProperties(app_working_state_1.MCP_APP_PATCH_FORM_INPUT_SCHEMA, ['versionToken', 'patch'], ['patch'])
    }
};
function validateDirectActionArgs(actionType, args) {
    const definition = exports.DIRECT_ACTION_DEFINITIONS[actionType];
    if (!definition) {
