...
export declare enum DraftBranchStatus {
    ACTIVE = "active",
...
export declare enum DraftValidationSeverity {
    INFO = "info",
    WARNING = "warning",
    ERROR = "error"
}
export declare enum DraftValidationCode {
...
export declare enum DraftCommitSource {
    PROPOSAL = "proposal",
    MANUAL = "manual",
    AUTOSAVE = "autosave",
    SYSTEM = "system"
