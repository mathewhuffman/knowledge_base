...
export enum ArticleAiMessageRole {
  SYSTEM = 'system',
  USER = 'user',
  ASSISTANT = 'assistant'
}

export enum ArticleAiMessageKind {
  CHAT = 'chat',
  EDIT_RESULT = 'edit_result',
  DECISION = 'decision'
}

export enum ArticleAiPresetAction {
...
export enum ArticleAiSessionStatus {
  IDLE = 'idle',
  RUNNING = 'running',
