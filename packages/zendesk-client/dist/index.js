...
let macOsCertificateBundle;
function getMacOsCertificateBundle() {
    ...
    try {
        const pemBundle = (0, node_child_process_1.execSync)('security find-certificate -a -p /System/Library/Keychains/SystemRootCertificates.keychain 2>/dev/null; ' +
            ...
            'security find-certificate -a -p ~/Library/Keychains/login.keychain-db 2>/dev/null', { encoding: 'utf8', timeout: 5000 }).trim();
